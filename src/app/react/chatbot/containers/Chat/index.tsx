...
declare global {
  interface Window { webchatMethods: { getMemory: Function } }
}
...
class Chat extends React.Component<Props, State> {
  ...
  */
  ...
  sendMessage = (attachment: any, userMessage?: any): void => {
    const {
      token,
      channelId,
      chatId,
    ...
    const payload = { message: { attachment }, chatId, memoryOptions: undefined }
    if (readOnlyMode) {
      return
    }
